            ...
            <div className="container mx-auto px-6 max-w-5xl">
                ...
                >
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-lg md:text-xl text-gray-700 leading-relaxed" style={{fontFamily: 'var(--font-inter), sans-serif'}}>
                        ...
                        <p className="text-lg md:text-xl text-gray-700 leading-relaxed border-l-4 border-gray-400 pl-8 italic bg-gray-100 py-6 rounded-r-lg" style={{fontFamily: 'var(--font-inter), sans-serif'}}>
